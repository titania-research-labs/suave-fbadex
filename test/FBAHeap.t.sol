...
contract TestForge is Test, SuaveEnabled {
    ...
    function testInsertBidOrderList() public {
        ...
        FBAHeap.FBAOrder memory insertedOrd1 = FBAHeap.FBAOrder(101, side, 100, "abcd");
        FBAHeap.FBAOrder memory insertedOrd2 = FBAHeap.FBAOrder(102, side, 200, "efgh");
        FBAHeap.FBAOrder memory insertedOrd3 = FBAHeap.FBAOrder(103, side, 300, "ijkl");
        FBAHeap.FBAOrder memory insertedOrd4 = FBAHeap.FBAOrder(104, side, 400, "mnop");
        FBAHeap.FBAOrder memory insertedOrd5 = FBAHeap.FBAOrder(105, side, 500, "qrst");
        ...
        assertEq(insertedOrd5.clientId, peekedOrd.clientId);
    }
    ...
    function testInsertAskOrderList() public {
        ...
        FBAHeap.FBAOrder memory insertedOrd1 = FBAHeap.FBAOrder(105, side, 100, "abcd");
        FBAHeap.FBAOrder memory insertedOrd2 = FBAHeap.FBAOrder(104, side, 200, "efgh");
        FBAHeap.FBAOrder memory insertedOrd3 = FBAHeap.FBAOrder(103, side, 300, "ijkl");
        FBAHeap.FBAOrder memory insertedOrd4 = FBAHeap.FBAOrder(102, side, 400, "mnop");
        FBAHeap.FBAOrder memory insertedOrd5 = FBAHeap.FBAOrder(101, side, 500, "qrst");
        FBAHeap.insertOrder(insertedOrd1, am, mm);
        FBAHeap.insertOrder(insertedOrd2, am, mm);
        FBAHeap.insertOrder(insertedOrd3, am, mm);
        FBAHeap.insertOrder(insertedOrd4, am, mm);
    ...
    function testDeleteBidOrder() public {
        ...
        FBAHeap.insertOrder(insertedOrd1, am, mm);
        FBAHeap.insertOrder(insertedOrd2, am, mm);
        FBAHeap.deleteOrder(insertedOrd2.clientId, side, am, mm);

        FBAHeap.FBAOrder memory peekedOrd = FBAHeap.getTopOrder(am, side, getExtPrice(side));

        assertEq(insertedOrd1.amount, peekedOrd.amount);
        assertEq(insertedOrd1.price, peekedOrd.price);
        assertEq(insertedOrd1.clientId, peekedOrd.clientId);
    }
    ...
    function testDeleteAskOrder() public {
        ...
        FBAHeap.FBAOrder memory insertedOrd1 = FBAHeap.FBAOrder(101, side, 456, "efgh");
        FBAHeap.FBAOrder memory insertedOrd2 = FBAHeap.FBAOrder(100, side, 123, "abcd");
